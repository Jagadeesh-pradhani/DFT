...
// Generated on: Feb 19 2025 02:35:21 EST (Feb 19 2025 07:35:21 UTC)

// Verification Directory fv/counter 

module counter(clk, reset, enable, count, SE, scan_in, scan_out);
  input clk, reset, enable, SE, scan_in;
  output [3:0] count;
  output scan_out;
  wire clk, reset, enable, SE, scan_in;
  wire [3:0] count;
  wire scan_out;
