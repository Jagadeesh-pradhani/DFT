...
build_model \
    -cell	 s298 \
    -techlib	 LIB/slow.v \
    -designsource	 $WORKDIR/s298.test_netlist.v \
...
build_testmode \
    -testmode	 FULLSCAN \
    -assignfile	 $WORKDIR/s298.FULLSCAN.pinassign \
    -modedef	 FULLSCAN \
...
#-------------------------------------------------------------------------------
create_logic_tests \
    -experiment	 s298_atpg \
    -testmode	 FULLSCAN \

check_log log_create_logic_tests_FULLSCAN_s298_atpg
...
#-------------------------------------------------------------------------------
write_vectors \
    -inexperiment	 s298_atpg \
    -testmode	 FULLSCAN \
    -language	 verilog \
    -scanformat	 parallel \

check_log log_write_vectors_FULLSCAN_s298_atpg
...
check_log log_commit_tests_FULLSCAN_s298_atpg
