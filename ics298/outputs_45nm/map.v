...
// Generated on: Feb 13 2025 10:10:29 IST (Feb 13 2025 04:40:29 UTC)
...
module s298(GND, VDD, CK, G0, G1, G117, G118, G132, G133, G2, G66, G67);
  ...
  OAI2BB1X1 g1122__1705(.A0N (G133), .A1N (n_45), .B0 (n_23), .Y
       (n_43));
  DFFQX2 DFF_2_q_reg(.CK (CK), .D (n_24), .Q (G12));
  OAI221X1 g1114__5122(.A0 (n_0), .A1 (n_41), .B0 (G11), .B1 (n_31),
       .C0 (n_30), .Y (n_42));
  DFFQX2 DFF_1_q_reg(.CK (CK), .D (n_29), .Q (G11));
  ...
  MXI2X1 g1134__5477(.A (n_14), .B (G11), .S0 (G13), .Y (n_15));
  ...
  OR3X2 g1144__8428(.A (G15), .B (n_11), .C (n_5), .Y (n_41));
  DFFHQX1 DFF_0_q_reg(.CK (CK), .D (n_6), .Q (G10));
  INVX2 g1151(.A (n_28), .Y (n_19));
  ...
  NAND2X2 g1148__2802(.A (G11), .B (n_11), .Y (n_37));
  NOR2X2 g1155__1705(.A (G12), .B (n_35), .Y (n_28));
  ...
  INVX2 g1161(.A (G13), .Y (n_35));
  INVX2 g1160(.A (G14), .Y (n_11));
  INVX1 g1157(.A (G117), .Y (n_2));
  INVX1 g1156(.A (G132), .Y (n_1));
  INVX1 g1163(.A (G67), .Y (n_0));
  INVX2 g1162(.A (G11), .Y (n_20));
endmodule
