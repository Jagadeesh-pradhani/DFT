...
# Generated on: Thu Feb 13 12:15:42 IST 2025 (Thu Feb 13 06:45:42 UTC 2025)
...
set logfile fv/s298/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/s298 -revised fv_map
...
read_library -liberty -both \
    /cad_area/install/FOUNDRY/digital/90nm/dig/lib/slow.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  RTL/s298_Mod.v
elaborate_design -golden -root {s298} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/s298/fv_map.v.gz
elaborate_design -revised -root {s298}
...
#add_name_alias fv/s298/fv_map.singlebit.original_name.alias.json.gz -revised
...
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  
#  1      VDD                            shift_enable     true       false       port        none                       false                 true          auto       
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------  
add_pin_constraints 0 {VDD} -golden
add_pin_constraints 0 {VDD} -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.s298.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.s298.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.s298.rtl.fv_map.rpt
