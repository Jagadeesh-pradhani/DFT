...
# Generated on: Fri Feb 14 16:07:34 IST 2025 (Fri Feb 14 10:37:34 UTC 2025)
...
set logfile fv/mcrb/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/mcrb -revised fv_map
...
read_library -liberty -both \
    /home/adld21ee114/DFT/DFT/mcrb/LIB/NanGate/45nm/FreePDK45_lib_v1.0_typical.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  RTL/mcrb.v
elaborate_design -golden -root {mcrb} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/mcrb/fv_map.v.gz
elaborate_design -revised -root {mcrb}
...
#add_name_alias fv/mcrb/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.mcrb.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.mcrb.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.mcrb.rtl.fv_map.rpt
