...
build_model \
    -cell	 mcrb \
    -techlib	 LIB/slow.v \
    -designsource	 $WORKDIR/mcrb.test_netlist.v \
...
build_testmode \
    -testmode	 FULLSCAN \
    -assignfile	 $WORKDIR/mcrb.FULLSCAN.pinassign \
    -modedef	 FULLSCAN \
...
#-------------------------------------------------------------------------------
create_logic_tests \
    -experiment	 mcrb_atpg \
    -testmode	 FULLSCAN \

check_log log_create_logic_tests_FULLSCAN_mcrb_atpg
...
#-------------------------------------------------------------------------------
write_vectors \
    -inexperiment	 mcrb_atpg \
    -testmode	 FULLSCAN \
    -language	 verilog \
    -scanformat	 parallel \

check_log log_write_vectors_FULLSCAN_mcrb_atpg
...
check_log log_commit_tests_FULLSCAN_mcrb_atpg
